...
Router.register('/online-classes', async () => {
  ...
  const liveBroadcastCard = hasAnyLive ? `
    <div class="relative w-full" style="background: var(--surface-2); border-radius: var(--radius-xl); padding: clamp(var(--sp-6), 5vw, var(--sp-10)); border: 1px solid var(--border-violet); text-align: center; box-shadow: var(--shadow-violet-md);">
      ...
      <p class="body-sm text-white font-semibold mb-6">Broadcasting Live from ${studioName}</p>
  ...
  ` : `
    <div class="relative w-full" style="background: var(--surface-2); border-radius: var(--radius-xl); padding: clamp(var(--sp-6), 5vw, var(--sp-12)); border: 1px solid var(--border-default); text-align: center; box-shadow: var(--shadow-xl);">
      ...
      <p class="body-sm text-white font-semibold">Broadcasting Live from ${studioName}</p>
  ...
  const html = `
    ...
    <section class="section section--alt border-top border-bottom">
      <div class="container">
        ...
        <div class="grid grid-3" style="gap: clamp(var(--sp-6), 6vw, var(--sp-12));">
          ...
          <!-- Live Plus -->
          <div class="card p-8 border bg-glass flex col justify-between" style="border-color: var(--violet);">
            <div>
      ...
      <div class="container">
        ...
        <div class="grid grid-3">
          <div class="card p-6 border bg-overlay">
            ...
            <h3 class="h5 text-white mb-2">Practice from Home</h3>
          ...
          <div class="card p-6 border bg-overlay">
            ...
            <h3 class="h5 text-white mb-2">Replay Anytime</h3>
          ...
          <div class="card p-6 border bg-overlay">
            ...
            <h3 class="h5 text-white mb-2">Track Milestones</h3>
    ...
    <section class="section section--alt border-top border-bottom">
      <div class="container grid grid-2 items-center" style="gap: clamp(var(--sp-6), 6vw, var(--sp-16));">
        <div>
          ...
          <h2 class="h2 text-white mb-6">Real-Time Performance Feedback</h2>
      ...
      <div class="container">
        ...
        <div class="grid grid-2" style="gap: clamp(var(--sp-4), 4vw, var(--sp-8));">
          <div class="card p-8 border">
            ...
            <h4 class="body-md text-white font-semibold">&mdash; Frederic Chopin</h4>
          ...
          <div class="card p-8 border">
            ...
            <p class="body-base italic text-secondary mb-6" style="font-size: clamp(var(--text-xs), 2vw, var(--text-base));">
              "The live masterclass reviews are phenomenal. Getting personal feedback on my fingering runs was exactly what I needed to pass ABRSM Grade 6."
            </p>
            <h4 class="body-md text-white font-semibold">&mdash; Sergei Rachmaninoff</h4>
    ...
    <section class="section section--glow border-top">
      <div class="container text-center py-8">
        ...
        <h2 class="display-md text-white mb-6" style="font-size: clamp(var(--text-xl), 5vw, var(--text-4xl));">Access the Virtual Classroom Now</h2>
        ...
        <div class="flex gap-4 sm\\:flex-col w-full justify-center items-center">
          ...
          <a href="/contact" class="btn btn--outline btn--lg w-fit text-center" style="min-width: 200px;">Inquire About Plans</a>
        </div>
      </div>
    </section>
  `;
