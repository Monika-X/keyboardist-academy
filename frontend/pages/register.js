  ...
  const html = `
    ...
    <section class="auth-container">
      ...
      <div class="auth-form-side">
        <div class="mb-10">
          <span class="badge badge--violet mb-4 shadow-sm" style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--violet);">Admissions</span>
          <h1 class="h2 text-primary" style="letter-spacing: -0.02em;">Start Your Journey</h1>
          <p class="body-lg text-secondary mt-2" style="max-width: 400px; line-height: 1.6;">Create a free account and explore our beginner syllabus.</p>
        </div>
        
        <form id="register-form" class="flex col gap-6 w-full">
          <div class="grid auth-name-grid" style="grid-template-columns: 1fr 1fr; gap: 1rem;">
            <div>
              <label for="reg-first" class="form-label label text-secondary mb-2 block font-medium" style="font-size: 0.85rem; letter-spacing: 0.02em; text-transform: uppercase;">First Name</label>
              <input type="text" id="reg-first" required class="auth-input" placeholder="Mozart" />
            </div>
            <div>
              <label for="reg-last" class="form-label label text-secondary mb-2 block font-medium" style="font-size: 0.85rem; letter-spacing: 0.02em; text-transform: uppercase;">Last Name</label>
              <input type="text" id="reg-last" required class="auth-input" placeholder="Wolfgang" />
            </div>
          </div>

          <div>
            <label for="reg-email" class="form-label label text-secondary mb-2 block font-medium" style="font-size: 0.85rem; letter-spacing: 0.02em; text-transform: uppercase;">Email Address</label>
            <input type="email" id="reg-email" required class="auth-input" placeholder="composer@academy.com" />
          </div>

          <div>
            <label for="reg-password" class="form-label label text-secondary mb-2 block font-medium" style="font-size: 0.85rem; letter-spacing: 0.02em; text-transform: uppercase;">Password</label>
            <div class="relative">
          ...
          <div>
            <label for="reg-confirm" class="form-label label text-secondary mb-2 block font-medium" style="font-size: 0.85rem; letter-spacing: 0.02em; text-transform: uppercase;">Confirm Password</label>
            <div class="relative">
          ...
          <button type="submit" class="btn btn--primary w-full mt-2" style="padding: 16px; border-radius: 8px; font-weight: 600; letter-spacing: 0.02em;">Join Academy</button>
        </form>
      ...
      <div class="auth-image-side">
        <img src="https://images.unsplash.com/photo-1511192336575-5a79af67a629?auto=format&fit=crop&q=80&w=1200" alt="Keyboard Synthesizer" class="w-full h-full object-cover" style="opacity: 0.4; filter: grayscale(100%) contrast(120%); mix-blend-mode: luminosity;" loading="lazy">
        ...
        <div class="absolute bottom-12 left-12 right-12">
          <div class="p-8" style="background: rgba(18, 18, 18, 0.6); backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.05); border-radius: 16px;">
            <p class="body-lg text-primary italic mb-4">"The beautiful thing about learning is that nobody can take it away from you."</p>
