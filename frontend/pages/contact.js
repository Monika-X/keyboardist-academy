...
Router.register('/contact', async () => {
  ...
  if (!app) return;  const html = `
    <!-- 1. HERO SECTION -->
    <section class="section  relative" style="padding-top: calc(var(--section-md) + 2rem); padding-bottom: 2rem;">
      <div class="container text-center">
        <span class="eyebrow mb-4">Connect With Us</span>
        <h1 class="display-lg text-primary mb-6" style="font-size: clamp(var(--text-2xl), 6vw, var(--text-6xl)); line-height: 1.15;">
          Get In Touch
        </h1>
        <p class="body-lg text-secondary mx-auto" style="max-width: 700px; font-size: clamp(var(--text-sm), 2vw, var(--text-base));">
          Have questions about our syllabus, batches, or pricing? Contact us and we will guide you on your learning path.
        </p>
      </div>
    </section>

    <!-- 2. CONTACT DETAILS & FORM -->
    <section class="section border-top" style="padding-top: 4rem;">
      <div class="container grid grid-2 gap-16 items-center">
        <!-- Contact Info & Socials -->
        <div class="reveal">
          <span class="eyebrow">Get In Touch</span>
          <h1 class="display-md text-primary mb-6" style="font-size: clamp(var(--text-xl), 5vw, var(--text-4xl));">Let's Connect</h1>
          ...
          <div class="flex col gap-6 mt-8">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h4 class="body-sm text-primary font-semibold">Location</h4>
                <p class="body-xs text-tertiary"><a href="https://maps.google.com/?q=Avadi,+Chennai,+Tamil+Nadu,+India" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none;" class="hover:text-primary transition-colors">Avadi, Chennai, Tamil Nadu, India (Online & Offline Classes)</a></p>
              </div>
            </div>
            <div class="flex items-center gap-4">
              ...
              <div>
                <h4 class="body-sm text-primary font-semibold">Phone Contact</h4>
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                <h4 class="body-sm text-primary font-semibold">WhatsApp Inquiry</h4>
          ...
          <!-- Social Media Links -->
          <div class="mt-12">
            <h4 class="label text-primary mb-4">Follow Our Channels</h4>
            <div class="flex gap-4">
              <a href="https://www.youtube.com/@agilanmusiq" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="social-icon flex items-center justify-center bg-overlay border-subtle border hover\:border-violet rounded-full" style="width: 44px; height: 44px; font-size: 20px; transition: all 0.3s;"><svg class="icon-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/></svg></a>
              <a href="https://www.instagram.com/agil_an__/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="social-icon flex items-center justify-center bg-overlay border-subtle border hover\:border-violet rounded-full" style="width: 44px; height: 44px; font-size: 20px; transition: all 0.3s;"><svg class="icon-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></a>
            </div>
          </div>
        </div>
        ...
        <!-- Contact Form -->
        <div class="reveal">
          <div class="card p-8 border bg-overlay border-subtle">
            <h3 class="h4 text-primary mb-6">Send Message</h3>
    ...
    <!-- 3. OPERATING HOURS & COMMITMENT -->
    <section class="section border-top border-bottom bg-raised">
      <div class="container text-center">
        <div class="section-header section-header--center">
          <span class="eyebrow">Availability</span>
          <h2 class="section-header__title">Studio Admissions Assistance</h2>
        </div>
        <p class="body-md text-secondary mx-auto mb-6" style="max-width: 600px;">
          Our administration office is available to coordinate batch slots and schedule admissions consultations.
        </p>
        <p class="body-xs text-tertiary">All online and offline inquiries will receive a reply within 24 hours.</p>
      </div>
    </section>

    <!-- 4. EMBEDDED MAP -->
    <section class="section border-bottom p-0" style="overflow: hidden;">
    ...
    <section class="section border-top">
      <div class="container text-center py-8">
        <h2 class="display-md text-primary mb-6" style="font-size: clamp(var(--text-xl), 5vw, var(--text-4xl));">Ready to Start Learning?</h2>
        <p class="body-md text-secondary mb-12 mx-auto" style="max-width: 600px;">
          Submit your admissions query or request a free consultation to find the perfect cohort for your level.
        </p>
        <div class="flex gap-4 sm\:flex-col w-full justify-center items-center">
          <a href="/admission" class="btn btn--primary btn--lg w-fit text-center" style="min-width: 200px;">Start Application</a>
        </div>
      </div>
    </section>
  `;
