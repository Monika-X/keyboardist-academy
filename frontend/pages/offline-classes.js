  ...
  const html = `
    ...
    <section class="section  relative" style="padding-top: calc(var(--section-md) + 2rem);">
      <div class="container text-center">
        ...
        <p class="body-lg text-secondary mx-auto mb-12" style="max-width: 700px; font-size: clamp(var(--text-sm), 2vw, var(--text-base));">
          Practice on premium acoustic grand pianos, study in acoustically optimized chambers, and receive direct, personal, tactile coaching in Avadi, Chennai.
        </p>
      </div>
    </section>
    ...
    <section class="section section--alt border-top border-bottom">
      <div class="container grid grid-2" style="gap: clamp(var(--sp-6), 6vw, var(--sp-12));">
        ...
        <div class="card p-8 border bg-overlay border-subtle">
          ...
          <h2 class="h3 text-primary mb-4">World-Class Pianos</h2>
          <p class="body-sm text-secondary">
            Our campus features a fleet of concert-grade acoustic grand pianos, premium Yamaha hybrid keyboards, and dedicated digital labs equipped with advanced audio workstations. Every instrument is meticulously tuned and maintained daily.
          </p>
        </div>
        ...
        <div class="card p-8 border bg-overlay border-subtle">
          ...
          <h2 class="h3 text-primary mb-4">Acoustic Optimization</h2>
          <p class="body-sm text-secondary">
    ...
    <section class="section">
      <div class="container">
        <div class="section-header section-header--center">
          ...
          <p class="section-header__desc">Join physical cohorts led by experienced and certified concert pianists.</p>
        </div>
          ...
          <div class="card hover\:scale overflow-hidden flex col justify-between">
            <div>
              ...
              <div class="p-6">
                ...
                <h3 class="h5 text-primary mt-2 mb-3">Traditional Piano Foundations</h3>
          ...
          <div class="card hover\:scale overflow-hidden flex col justify-between">
            <div>
              ...
              <div class="p-6">
                ...
                <h3 class="h5 text-primary mt-2 mb-3">Concert Virtuoso Program</h3>
    ...
    <section class="section section--alt border-top border-bottom">
      <div class="container">
        <div class="section-header section-header--center">
          ...
          <p class="section-header__desc">We limit cohorts to 6 students per session to guarantee personal instructor attention in Avadi, Chennai.</p>
        </div>

        <div class="grid grid-3" style="gap: clamp(var(--sp-6), 6vw, var(--sp-12));">
          <!-- Weekday Morning -->
          <div class="card p-8 border bg-overlay border-subtle text-center flex col justify-between">
            <div>
              <h3 class="h4 text-primary mb-2">Morning Cohort</h3>
              <p class="body-xs text-secondary mb-6">Monday & Wednesday</p>
              <div class="display-md text-primary font-bold mb-6">09:00<br>AM</div>
          ...
          <!-- Weekday Evening -->
          <div class="card p-8 border bg-overlay border-subtle text-center flex col justify-between" style="border-color: var(--violet);">
            <div>
              <h3 class="h4 text-primary mb-2">Evening Cohort</h3>
              <p class="body-xs text-secondary mb-6">Tuesday & Thursday</p>
              <div class="display-md text-primary font-bold mb-6">06:30<br>PM</div>
          ...
          <div class="card p-8 border bg-overlay border-subtle text-center flex col justify-between">
            <div>
              <h3 class="h4 text-primary mb-2">Weekend Studio</h3>
              <p class="body-xs text-secondary mb-6">Saturday Intensive</p>
              <div class="display-md text-primary font-bold mb-6">10:00<br>AM</div>
    ...
    <section class="section ">
      <div class="container text-center py-8">
        ...
        <h2 class="display-md text-primary mb-6" style="font-size: clamp(var(--text-xl), 5vw, var(--text-4xl));">Schedule a Private Campus Tour</h2>
        <p class="body-md text-secondary mb-12 mx-auto" style="max-width: 600px;">
          Meet our world-class faculty, view our premium grand pianos, and consult with our principal on the right program for you.
        </p>
